...
export const shopTagDefinitions: ShopTagDefinition[] = [
  ...
  { shopifyTag: 'P', category: 'Creator', displayEn: 'P-Chan', displayCn: 'P-Chan', color: '#ff78a8' },
  { shopifyTag: 'Riki', category: 'Creator', displayEn: 'Riki', displayCn: 'Riki', color: '#b498ff' },
